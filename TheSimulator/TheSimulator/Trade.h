...
public:
	Trade(TradeID id, Timestamp timestamp, OrderDirection direction, const OrderID& aggressingOrderID, const OrderID& restingOrderID, Volume volume, Money price);
	...
	inline const OrderID& aggressingOrderID() const { return m_aggressingOrderID; }
	inline const OrderID& restingOrderID() const { return m_restingOrderID; }
